...
export default function AdminStoreStrip({
  ...
  return (
    <aside className={`console-panel sticky z-20 overflow-hidden rounded-[30px] border border-sky-100/80 bg-[linear-gradient(180deg,rgba(249,252,255,0.98),rgba(240,247,255,0.94))] shadow-[0_24px_60px_-42px_rgba(14,165,233,0.45)] backdrop-blur ${stickyTopClassName}`}>
